...
return [
    ...
    'user_auth_key'           => 'desktop_auth_id',    // 用户认证 SESSION 标记
	'user_auth_app'           => 'desktop_auth_id',    // app SESSION 标记

    'admin_auth_key'          => 'desktop',
    'user_auth_model'         => 'DesktopUser',    // 默认验证数据表模型
    'user_auth_gateway'       => 'Pub/login',    // 默认认证网关
    'not_auth_controller'     => 'Index,ClientInfoContact,ClientinfoAddress,ProductinfoRule,ProductinfoPromotion,ProductinfoGroup',        // 默认无需认证控制器，多级控制器使用点语法，严格大小写，多个逗号隔开
