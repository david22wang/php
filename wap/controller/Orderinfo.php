...
{
    use \app\wap\traits\controller\Controller;
	...
	{	//新手订单组合列表	
		$client_info_id=CLIENTID;
		 $tbl_pre ="tp_";
			...
			$listRows = $this->request->param('numPerPage') ?: 10;
     		$search=['main.isdelete'  =>0,'main.clientid'=>$client_info_id,'main.ordertp'=>5,'main.substatus'=>1,'main.status'=>1 ] ;
				//条件查询
